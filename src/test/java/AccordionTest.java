...
public class AccordionTest {
    ...
    public AccordionTest(int paramSelect, int paramContent, String text) {
        this.paramSelect = paramSelect;
        this.paramContent = paramContent;
        this.text = text;
    }

    // Параметры для параметризации тестовых данных
    ...
    public void tearDown() {
        // В этом месте браузер будет закрыт после каждого теста
    }

    @Test
    public void checkAccordionItem() {
        faqPage.open();
        faqPage.scrollToAccordion();
        faqPage.checkImportantQuestionsText(paramSelect, paramContent, text);
    }
}
